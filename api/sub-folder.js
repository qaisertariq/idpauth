...
module.exports = async (req, res) => {
  ...
  req.on('end', async () => {
    try {
      const { accessToken, accessTokenSecret, nickname, folderName, mainfolder, urlname } = JSON.parse(body);

      if (!accessToken || !accessTokenSecret || !nickname || !folderName || !mainfolder || !urlname) {
